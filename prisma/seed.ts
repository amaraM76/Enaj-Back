...
async function main() {
  ...
  const products = await Promise.all(
    [
      // Skin & Body Care
      { slug: "glow-radiance-sunscreen", name: "Glow Radiance Face Sunscreen SPF 50", brand: "SunCare Co.", price: "$24.99", ingredients: ["Water", "Homosalate", "Alcohol Denat", "Octocrylene", "Butyl Methoxydibenzoylmethane", "Fragrance", "Phenoxyethanol", "Tocopherol"], category: ProductCategory.SKIN_BODY },
      { slug: "pure-mineral-sunscreen", name: "Pure Mineral Face Sunscreen SPF 45", brand: "CleanSkin Labs", price: "$28.99", ingredients: ["Water", "Zinc Oxide", "Titanium Dioxide", "Glycerin", "Jojoba Oil", "Aloe Vera", "Vitamin E"], category: ProductCategory.SKIN_BODY },
      { slug: "gentle-shield-sunscreen", name: "Gentle Shield Mineral Sunscreen SPF 40", brand: "NatureGlow", price: "$22.50", ingredients: ["Water", "Zinc Oxide", "Shea Butter", "Green Tea Extract", "Hyaluronic Acid", "Squalane"], category: ProductCategory.SKIN_BODY },
      { slug: "organic-daily-moisturizer", name: "Organic Daily Moisturizer", brand: "PureBloom", price: "$19.99", ingredients: ["Water", "Aloe Vera", "Jojoba Oil", "Shea Butter", "Vitamin E", "Chamomile Extract"], category: ProductCategory.SKIN_BODY },
      { slug: "calming-body-lotion", name: "Calming Body Lotion", brand: "SoftTouch", price: "$16.99", ingredients: ["Water", "Glycerin", "Dimethicone", "Fragrance", "Parabens", "Cetyl Alcohol", "Aloe Vera"], category: ProductCategory.SKIN_BODY },

      // Haircare
      { slug: "volumizing-shampoo", name: "Volumizing Shampoo", brand: "LushLocks", price: "$14.99", ingredients: ["Water", "Sodium Lauryl Sulfate", "Cocamidopropyl Betaine", "Fragrance", "Dimethicone", "Citric Acid", "Sodium Chloride"], category: ProductCategory.HAIRCARE },
      { slug: "sulfate-free-repair-shampoo", name: "Sulfate-Free Repair Shampoo", brand: "GentleMane", price: "$18.50", ingredients: ["Water", "Decyl Glucoside", "Glycerin", "Argan Oil", "Keratin", "Aloe Vera", "Vitamin E"], category: ProductCategory.HAIRCARE },
      { slug: "deep-conditioning-mask", name: "Deep Conditioning Mask", brand: "SilkRoots", price: "$22.00", ingredients: ["Water", "Cetearyl Alcohol", "Coconut Oil", "Shea Butter", "Dimethicone", "Fragrance", "Propylene Glycol"], category: ProductCategory.HAIRCARE },

      // Makeup
      { slug: "flawless-matte-foundation", name: "Flawless Matte Foundation", brand: "GlowUp", price: "$32.00", ingredients: ["Water", "Dimethicone", "Titanium Dioxide", "Fragrance", "Parabens", "Talc", "Glycerin", "Iron Oxides"], category: ProductCategory.MAKEUP },
      { slug: "clean-coverage-bb-cream", name: "Clean Coverage BB Cream", brand: "BareSkin", price: "$26.00", ingredients: ["Water", "Zinc Oxide", "Jojoba Oil", "Glycerin", "Hyaluronic Acid", "Aloe Vera", "Iron Oxides"], category: ProductCategory.MAKEUP },
      { slug: "long-lasting-mascara", name: "Long-Lasting Mascara", brand: "BoldLash", price: "$15.00", ingredients: ["Water", "Beeswax", "Carnauba Wax", "Iron Oxides", "Parabens", "Fragrance", "Polyethylene"], category: ProductCategory.MAKEUP },

      // Food
      { slug: "berry-blast-protein-bar", name: "Berry Blast Protein Bar", brand: "FitFuel", price: "$3.49", ingredients: ["Whey Protein", "Oats", "Honey", "Mixed Berries", "Coconut Oil", "Soy Lecithin", "Natural Flavors"], category: ProductCategory.FOOD },
      { slug: "clean-protein-bar", name: "Clean Protein Bar", brand: "GreenFit", price: "$4.29", ingredients: ["Pea Protein", "Oats", "Maple Syrup", "Almonds", "Cocoa Butter", "Sea Salt"], category: ProductCategory.FOOD },
      { slug: "sparkling-citrus-energy-drink", name: "Sparkling Citrus Energy Drink", brand: "ZestBoost", price: "$2.99", ingredients: ["Carbonated Water", "High Fructose Corn Syrup", "Citric Acid", "Natural Flavors", "Caffeine", "Sucralose", "Red 40", "Yellow 5"], category: ProductCategory.FOOD },
      { slug: "organic-trail-mix", name: "Organic Trail Mix", brand: "NatureHarvest", price: "$7.99", ingredients: ["Almonds", "Cashews", "Raisins", "Dark Chocolate", "Coconut Flakes", "Sea Salt"], category: ProductCategory.FOOD },

      // Cleaning
      { slug: "all-purpose-surface-cleaner", name: "All-Purpose Surface Cleaner", brand: "SparkleHome", price: "$5.99", ingredients: ["Water", "Sodium Lauryl Sulfate", "Fragrance", "Triclosan", "Formaldehyde", "Chlorine Bleach", "Ammonia"], category: ProductCategory.CLEANING },
      { slug: "plant-based-multi-surface-spray", name: "Plant-Based Multi-Surface Spray", brand: "EcoClean", price: "$8.49", ingredients: ["Water", "Decyl Glucoside", "Citric Acid", "Essential Oils", "Aloe Vera"], category: ProductCategory.CLEANING },
      { slug: "heavy-duty-bathroom-cleaner", name: "Heavy-Duty Bathroom Cleaner", brand: "PowerWash", price: "$6.49", ingredients: ["Water", "Sodium Hypochlorite", "Fragrance", "Sodium Lauryl Sulfate", "PFAS", "Formaldehyde"], category: ProductCategory.CLEANING },

      // Fragrance
      { slug: "midnight-orchid-parfum", name: "Midnight Orchid Eau de Parfum", brand: "LuxeScent", price: "$85.00", ingredients: ["Alcohol Denat", "Fragrance", "Parfum", "Diethyl Phthalate", "Limonene", "Linalool", "Coumarin"], category: ProductCategory.FRAGRANCE },
      { slug: "clean-reserve-warm-cotton", name: "Clean Reserve Warm Cotton", brand: "PureAura", price: "$62.00", ingredients: ["Alcohol", "Water", "Limonene", "Linalool", "Citronellol"], category: ProductCategory.FRAGRANCE },
      { slug: "botanical-body-mist", name: "Botanical Body Mist", brand: "GardenBloom", price: "$24.00", ingredients: ["Water", "Alcohol Denat", "Fragrance", "Propylene Glycol", "Parabens"], category: ProductCategory.FRAGRANCE },

      // Household
      { slug: "scented-candle-lavender", name: "Scented Candle - Lavender Fields", brand: "WarmGlow", price: "$18.99", ingredients: ["Paraffin Wax", "Fragrance", "Phthalate", "Artificial Colors", "Lead-core Wick"], category: ProductCategory.HOUSEHOLD },
      { slug: "soy-candle-vanilla", name: "Soy Candle - Vanilla Bean", brand: "PureFlame", price: "$22.50", ingredients: ["Soy Wax", "Essential Oils", "Cotton Wick"], category: ProductCategory.HOUSEHOLD },
      { slug: "fabric-softener-sheets", name: "Fabric Softener Sheets", brand: "FreshHome", price: "$7.99", ingredients: ["Dipalmitoylethyl Hydroxyethylmonium Methosulfate", "Fragrance", "Formaldehyde", "Chlorine Bleach", "Artificial Colors"], category: ProductCategory.HOUSEHOLD },
