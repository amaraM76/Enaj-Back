...
for (const ing of hormonalAcneIngredients) {
  ...
  const preferences = await Promise.all(
    [
      ...
      { slug: "no-artificial-sweeteners", name: "Artificial Sweeteners", description: "Avoid artificial sweeteners that can affect insulin response", categoryId: prefCatMap["metabolic-blood-sugar"] },
